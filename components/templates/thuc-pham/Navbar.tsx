    ...
    <header className="fixed top-0 left-0 right-0 z-50 bg-white/95 backdrop-blur-sm border-b border-green-100 shadow-sm">
      <div className="container mx-auto max-w-7xl px-4 h-16 flex items-center gap-4">
        ...
        <div className="flex items-center gap-2 ml-auto">
          ...
          <button
            onClick={openCart}
            className="hidden sm:flex relative w-9 h-9 items-center justify-center rounded-full hover:bg-green-50 transition-colors text-slate-600 hover:text-green-700"
          >
        ...
        <div className="md:hidden bg-white border-t border-green-100 shadow-lg">
          <div className="container mx-auto max-w-7xl px-4 py-4 space-y-1">
            ...
            <button
              ...
              className="flex items-center gap-2 w-full px-4 py-3 rounded-xl text-slate-700 hover:bg-green-50 hover:text-green-700 font-medium text-sm transition-colors"
            >
              Giỏ hàng
              {itemCount > 0 && (
                <span className="ml-auto w-5 h-5 bg-green-600 text-white text-[10px] font-bold rounded-full flex items-center justify-center">
                  {itemCount}
                </span>
              )}
            </button>
